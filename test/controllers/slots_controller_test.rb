...
class SlotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slot" do
    assert_difference("Slot.count") do
      post slots_url, params: { slot: { professional: @slot.professional, service: @slot.service, start_time: @slot.start_time } }
    end
  ...
  test "should update slot" do
    patch slot_url(@slot), params: { slot: { professional: @slot.professional, service: @slot.service, start_time: @slot.start_time } }
